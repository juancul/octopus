...
class Admin
{
    ...
    public function add_section_main_subsection_google_ads( $section_ids )
    {
        ...
        add_settings_field(
            ...
            esc_html__( 'Google Analytics UA', 'woocommerce-google-adwords-conversion-tracking-tag' ) . $this->svg_beta(),
        ...
        add_settings_field(
            ...
            esc_html__( 'Google Analytics 4', 'woocommerce-google-adwords-conversion-tracking-tag' ) . $this->svg_beta(),
    ...
    public function add_section_main_subsection_facebook( $section_ids )
    {
        ...
        add_settings_field(
            ...
            esc_html__( 'Facebook pixel ID', 'woocommerce-google-adwords-conversion-tracking-tag' ) . $this->svg_beta(),
    ...
    public function add_section_main_subsection_more_pixels( $section_ids )
    {
        ...
        add_settings_field(
            ...
            esc_html__( 'Hotjar site ID', 'woocommerce-google-adwords-conversion-tracking-tag' ) . $this->svg_beta(),
    ...
    public function add_section_advanced_subsection_shop( $section_ids )
    {
        ...
        add_settings_field(
            ...
            esc_html__( 'Order deduplication', 'woocommerce-google-adwords-conversion-tracking-tag' ),
    ...
    public function add_section_beta()
    {
        ...
        add_settings_section(
            ...
            esc_html__( 'Beta', 'woocommerce-google-adwords-conversion-tracking-tag' ),
        ...
        add_settings_field(
            ...
            esc_html__( 'Activation', 'woocommerce-google-adwords-conversion-tracking-tag' ),
        ...
        add_settings_field(
            ...
            esc_html__( 'aw_merchant_id', 'woocommerce-google-adwords-conversion-tracking-tag' ),
        ...
        add_settings_field(
            ...
            esc_html__( 'aw_feed_country', 'woocommerce-google-adwords-conversion-tracking-tag' ),
        ...
        add_settings_field(
            ...
            esc_html__( 'aw_feed_language', 'woocommerce-google-adwords-conversion-tracking-tag' ),
    ...
    public function wgact_plugin_options_page()
    {
        ...
        echo  $this->get_link_locale() ;
        ?>/?utm_source=plugin&utm_medium=banner&utm_campaign=wgact_plugin"
    ...
    public function wgact_setting_html_order_deduplication()
    {
        ...
        ?> />
            <?php 
        $this->get_order_deduplication_text();
        ?></label>
        <?php 
