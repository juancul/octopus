...
if ( $tracking_items ) : 
	...
	$show_simple_shipped_date = $ast->get_option_value_from_array('tracking_info_settings','show_simple_shipped_date',$wcast_customizer_settings->defaults['show_simple_shipped_date']);	
			...
			?>	
				<li class="tracking_list_li">
					<div class="tracking_list_div" style="font-size:<?php echo $simple_provider_font_size; ?>px;color:<?php echo $simple_provider_font_color; ?>;border-bottom:<?php echo $show_provider_border; ?>px solid <?php echo $provider_border_color; ?>">
						<?php echo apply_filters( 'ast_provider_title', esc_html( $tracking_item['formatted_tracking_provider'] )); ?> - <a href="<?php echo esc_url( $url ); ?>" target="_blank"><?php echo esc_html( $tracking_item['tracking_number'] ); ?></a> <?php if($show_simple_shipped_date == 1) { ?>- <time datetime="<?php echo date( 'Y-m-d', $date_shipped ); ?>" title="<?php echo date( 'Y-m-d', $date_shipped ); ?>"><?php echo date_i18n( get_option( 'date_format' ), $date_shipped ); ?></time><?php } ?>
					</div>
				...
				<tr class="tracking">
					...
					<td class="tracking-number" data-title="<?php _e( 'Tracking Number', 'woo-advanced-shipment-tracking' ); ?>" style="<?php echo $td_column_style; ?>">
						<?php if($tracking_item['formatted_tracking_link'] && $tracking_number_link){ 
								$url = str_replace('%number%',$tracking_item['tracking_number'],$tracking_item['formatted_tracking_link']); ?>	
								<a href="<?php echo esc_url( $url ); ?>" style="<?php echo $tracking_link_style; ?>" target="_blank"><?php echo esc_html( $tracking_item['tracking_number'] ); ?></a>
						<?php } else{
