...
function my_automatewoo_subscrition_status_finalized_offer( $workflow ) {
    ...
    //Automatewoo log
    $workflow->log_action_note( $workflow , __( 'Ssubscription moved to finalized with offer (expired-offer) with order id:'.$order_id. ' and offer id: '.$offer_id.' Subscription id: '.$subscription_id, 'automatewoo' ) );
}