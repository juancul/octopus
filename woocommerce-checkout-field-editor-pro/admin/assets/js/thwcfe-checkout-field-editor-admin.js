var thwcfe_settings = (function($, window, document) {
	...
	*------------------------------------*/	 	
	var SECTION_FORM_FIELDS = {
		...
		inherit_display_rule  : {name : 'inherit_display_rule', type : 'checkbox', value : 'yes', checked : true},
		inherit_display_rule_ajax  : {name : 'inherit_display_rule_ajax', type : 'checkbox', value : 'yes', checked : true},
		auto_adjust_display_rule_ajax  : {name : 'auto_adjust_display_rule_ajax', type : 'checkbox', value : 'yes', checked : true},
	};
	 ...
	 *------------------------------------*/
	 var FIELD_FORM_PROPS = {
		...
		inherit_display_rule  : {name : 'inherit_display_rule', type : 'checkbox'},
		inherit_display_rule_ajax  : {name : 'inherit_display_rule_ajax', type : 'checkbox'},
		auto_adjust_display_rule_ajax  : {name : 'auto_adjust_display_rule_ajax', type : 'checkbox'},
	};
