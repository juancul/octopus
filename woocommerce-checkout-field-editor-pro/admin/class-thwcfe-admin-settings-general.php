	...
	*------------------------------------------*/
	...
	private function render_field_form_fragment_repeat($type="field"){
        ...
        <tr>
        	...
        	<td colspan="4">
        	<?php
        	$this->render_form_field_element($form_props['inherit_display_rule'], $this->cell_props_CBS, false);
			?>
            </td>
        </tr>
        <tr>
        	...
        	<td colspan="4">
        	<?php
        	$this->render_form_field_element($form_props['inherit_display_rule_ajax'], $this->cell_props_CBS, false);
			?>
            </td>
        </tr>
        <tr>
        	...
        	<td colspan="4">
        	<?php
        	$this->render_form_field_element($form_props['auto_adjust_display_rule_ajax'], $this->cell_props_CBS, false);
			?>
            </td>
        </tr>
        <?php
