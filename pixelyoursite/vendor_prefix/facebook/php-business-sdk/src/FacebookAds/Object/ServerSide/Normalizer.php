...
class Normalizer
{
    ...
    public static function normalize($field, $data)
    {
        ...
        if (\PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\Util::isHashed($data)) {
            return $data;
        }
        ...
        switch ($field) {
            case 'em':
                $normalized_data = \PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\Normalizer::normalizeEmail($data);
                break;
            case 'ph':
                $normalized_data = \PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\Normalizer::normalizePhone($data);
                break;
            case 'zp':
                $normalized_data = \PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\Normalizer::normalizeZipCode($data);
                break;
            case 'ct':
                $normalized_data = \PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\Normalizer::normalizeCity($data);
                break;
            case 'st':
                $normalized_data = \PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\Normalizer::normalizeState($data);
                break;
            case 'country':
                $normalized_data = \PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\Normalizer::normalizeCountry($data);
                break;
            case 'currency':
                $normalized_data = \PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\Normalizer::normalizeCurrency($data);
                break;
            case 'f5first':
                $normalized_data = \PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\Normalizer::normalizeF5($data);
                break;
            case 'f5last':
                $normalized_data = \PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\Normalizer::normalizeF5($data);
                break;
            case 'fi':
                $normalized_data = \PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\Normalizer::normalizeFi($data);
                break;
            case 'dobd':
                $normalized_data = \PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\Normalizer::normalizeDobd($data);
                break;
            case 'dobm':
                $normalized_data = \PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\Normalizer::normalizeDobm($data);
                break;
            case 'doby':
                $normalized_data = \PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\Normalizer::normalizeDoby($data);
                break;
    ...
    private static function normalizePhone($phone)
    {
        ...
        if (\PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\Normalizer::isInternationalNumber($result)) {
    ...
    {
        $delivery_categories = \PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\DeliveryCategory::getInstance()->getValues();
        if (!\PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\DeliveryCategory::getInstance()->isValidValue($delivery_category)) {
