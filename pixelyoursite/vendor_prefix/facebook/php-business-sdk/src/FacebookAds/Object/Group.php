...
use PYS_PRO_GLOBAL\FacebookAds\Object\Values\GroupSuggestionCategoryValues;
...
class Group extends \PYS_PRO_GLOBAL\FacebookAds\Object\AbstractCrudObject
{
    ...
    protected static function getReferencedEnums()
    {
        ...
        $ref_enums['SuggestionCategory'] = \PYS_PRO_GLOBAL\FacebookAds\Object\Values\GroupSuggestionCategoryValues::getInstance()->getValues();
        return $ref_enums;
    }
    ...
    {
        $this->assureId();
        $param_types = array('admin' => 'int', 'description' => 'string', 'group_icon_id' => 'Object', 'group_type' => 'group_type_enum', 'join_setting' => 'join_setting_enum', 'name' => 'string', 'parent_id' => 'Object', 'post_permissions' => 'post_permissions_enum', 'post_requires_admin_approval' => 'bool', 'privacy' => 'string', 'ref' => 'string', 'suggestion_category' => 'suggestion_category_enum', 'suggestion_identifier' => 'string');
        $enums = array('group_type_enum' => \PYS_PRO_GLOBAL\FacebookAds\Object\Values\GroupGroupTypeValues::getInstance()->getValues(), 'join_setting_enum' => \PYS_PRO_GLOBAL\FacebookAds\Object\Values\GroupJoinSettingValues::getInstance()->getValues(), 'post_permissions_enum' => \PYS_PRO_GLOBAL\FacebookAds\Object\Values\GroupPostPermissionsValues::getInstance()->getValues(), 'suggestion_category_enum' => \PYS_PRO_GLOBAL\FacebookAds\Object\Values\GroupSuggestionCategoryValues::getInstance()->getValues());
