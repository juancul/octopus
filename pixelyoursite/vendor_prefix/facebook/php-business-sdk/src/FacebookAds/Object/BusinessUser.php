...
class BusinessUser extends \PYS_PRO_GLOBAL\FacebookAds\Object\AbstractCrudObject
{
    ...
    {
        return \PYS_PRO_GLOBAL\FacebookAds\Object\Fields\BusinessUserFields::getInstance();
    }
    protected static function getReferencedEnums()
    {
        $ref_enums = array();
        $ref_enums['Role'] = \PYS_PRO_GLOBAL\FacebookAds\Object\Values\BusinessUserRoleValues::getInstance()->getValues();
        return $ref_enums;
    }
    ...
    {
        $this->assureId();
        $param_types = array('clear_pending_email' => 'bool', 'email' => 'string', 'first_name' => 'string', 'last_name' => 'string', 'pending_email' => 'string', 'role' => 'role_enum', 'title' => 'string');
