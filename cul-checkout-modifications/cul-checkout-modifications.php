...
add_filter('woocommerce_before_checkout_form', 'custom_override_checkout_fields');
    ...
    if(isset($cart['subscription_renewal']) && isset($cart['subscription_renewal']['subscription_id'])) {
        ...
        /*echo ' <style>
                ...
                <div class="woocommerce-info">
                    <span class="cart-notice" style="color: #a374dd">En este momento no estamos recibiendo solicitudes nuevas de alquiler. Vuelve pronto!</span>
                </div>';*/
    }
    //return $fields;
}